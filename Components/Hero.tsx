...
//     { name: "React.js", icon: <FaReact size={35} className="text-sky-400" /> },
//     { name: "Python", icon: <FaPython size={35} className="text-yellow-500" /> },
//     { name: "TailwindCSS", icon: <SiTailwindcss size={35} className="text-teal-400" /> },
//   ];
...
//         >
//           I specialize in building intuitive and responsive web applications using modern technologies. Skilled in Next.js, React, Python, and Agentic AI.
//         </motion.p>
